...
// function nomess(){
//   for(i = 0; i < enemyspawnbrick.length--; i++){
//     if(enemies[i]){
//       if(dist(guy.x, guy.y, enemies[i].x, enemies[i].y) > 20){
//         enemies[i].pos.x = enemyspawnbrick[i].pos.x
//         enemies[i].pos.y = enemyspawnbrick[i].pos.y
//       }
//       else{
//         console.log("bean1")
//       }
